        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="mb-4 leading-relaxed">
              These Terms of Service ("Terms") provide the terms and conditions
              under which you, whether personally or on behalf of an entity
              ("you" or "your"), are permitted to use, interact with or
              otherwise access the platform and services provided by Radish
              Solutions LLC ("the Company," "we," "us," or "our"). These Terms,
              together with any documents and additional terms or policies that
              are appended hereto or that expressly incorporate these Terms by
              reference as well as our Privacy Policy (collectively, the
            ...
            <p className="mb-4 leading-relaxed">
              ...
              blockchain-based features (the "Blockchain Features") that may be
              available to users by connecting their self-hosted wallets via an
              Interface, including but not limited to the Site (the "Technology
              Features" and together with the Content Features, the "Features").
            </p>
            ...
            <div className="bg-riot-red/10 border border-riot-red/30 p-6 rounded-lg mb-6">
              ...
              <p className="text-sm leading-relaxed">
                ...
                SITE), ANY INTERFACE OR ANY FEATURE, YOU AGREE THAT YOU ARE ABLE
                TO ENTER INTO A BINDING AGREEMENT AND, AS SUCH, HAVE READ,
                UNDERSTOOD, AND AGREE TO BE BOUND BY THE TERMS, INCLUDING THE
                BINDING ARBITRATION AGREEMENT AND CLASS ACTION WAIVER BELOW. IF
                YOU DO NOT AGREE TO ALL OF THE TERMS, YOU ARE NOT AUTHORIZED TO
          ...
          <section className="mb-12">
            ...
            <p className="mb-4 leading-relaxed">
              Certain Features may involve blockchain technology, cryptocurrency
              transactions, and smart contracts. When you interact with these
              Features:
            </p>
            <ul className="list-disc list-inside mb-6 space-y-2 text-white/80">
              <li>
              ...
              <li>
                Transactions are processed on decentralized networks outside our
                control
              </li>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="bg-black/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm text-white/80">
                  You possess sufficient knowledge and skills to participate in
                  coding challenges, understand blockchain technology (if using
                  crypto features), and take responsibility for your digital
                  assets.
                </p>
              </div>
              ...
              <div className="bg-black/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm text-white/80">
                  Your use of the Platform complies with all applicable laws in
                  your jurisdiction, including those relating to online
            ...
            <ul className="list-disc list-inside mb-6 space-y-2 text-white/80">
              ...
              <li>
                Engage in fraudulent, deceptive, or manipulative behavior during
                competitions
              </li>
              <li>
                Share or collaborate on individual challenges unless explicitly
                permitted
              </li>
              <li>
              ...
              <li>
                Use automated tools, bots, or scripts to gain unfair advantages
              </li>
              ...
              <li>
                Use the platform for money laundering or other illegal financial
                activities
              </li>
            </ul>
            ...
            <div className="bg-riot-red/10 border border-riot-red/30 p-6 rounded-lg">
              ...
              <p className="text-sm leading-relaxed mb-4">
                Participation in crypto-backed competitions involves significant
                financial risk. You acknowledge and understand that:
              </p>
          ...
          <section className="mb-12">
            ...
            <p className="mb-4 leading-relaxed">
              ...
              automated testing, peer review, and expert evaluation. The Company
              reserves the right to review and verify all submissions for
              compliance with competition rules and terms of service.
            </p>
            ...
            <p className="mb-4 leading-relaxed">
              Prizes may include cryptocurrency, tokens, educational resources,
              career opportunities, or other valuable consideration. All prizes
              are subject to applicable tax obligations in your jurisdiction,
          ...
          <section className="mb-12">
            ...
            <p className="mb-4 leading-relaxed">
              The Company owns all right, title, and interest in the Code Riots
              platform, including but not limited to software, content,
            ...
            <ul className="list-disc list-inside mb-6 space-y-2 text-white/80">
              ...
              <li>Use aggregated data and insights for platform improvement</li>
              <li>
          ...
          <section className="mb-12">
            ...
            <p className="mb-4 leading-relaxed">
              ...
              using the Platform, you consent to our data practices as described
          ...
          <section className="mb-12">
            ...
            <p className="mb-4 leading-relaxed">
              ...
              we make no guarantees regarding specific learning outcomes, skill
              acquisition, or career advancement as a result of platform
              participation.
            </p>
            ...
            <div className="bg-black/50 p-4 rounded-lg border border-white/10">
              <p className="text-sm leading-relaxed">
                ...
                OF OR RELATING TO YOUR USE OF THE PLATFORM. OUR TOTAL LIABILITY
                SHALL NOT EXCEED $1,000 OR THE AMOUNT YOU PAID TO US IN THE 12
          ...
          <section className="mb-12">
            ...
            <p className="mb-4 leading-relaxed">
              ...
              consequences resulting from such modifications.
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="mb-4 leading-relaxed">
              ...
              resolution through good-faith negotiation for a period of 60 days
            ...
            <div className="bg-black/50 p-4 rounded-lg border border-white/10">
              <p className="text-sm leading-relaxed mb-4">
                Any unresolved disputes shall be settled by binding arbitration
                in accordance with the rules of the American Arbitration
                Association. Arbitration shall take place in Delaware, United
                States, and shall be conducted in English.
              </p>
